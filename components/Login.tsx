        ...
        <div className="space-y-4">
          ...
          >
            <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" fill="currentColor">
              <path d="M43.611 20.083H42V20H24v8h11.303c-1.649 4.657-6.08 8-11.303 8c-6.627 0-12-5.373-12-12s5.373-12 12-12c3.059 0 5.842 1.154 7.961 3.039L38.398 7.618C34.311 4.01 29.492 2 24 2C11.854 2 2 11.854 2 24s9.854 22 22 22s22-9.854 22-22c0-1.341-.138-2.65-.389-3.917z" />
              <path d="M6.306 14.691c-1.332 2.646-2.106 5.617-2.106 8.715s.774 6.069 2.106 8.715L11.531 32c-1.979-3.522-3.225-7.69-3.225-12s1.246-8.478 3.225-12L6.306 14.691z" />
              <path d="M24 46c5.94 0 11.213-1.996 15.086-5.342l-5.126-5.126c-2.344 1.566-5.276 2.468-8.96 2.468c-6.233 0-11.52-3.832-13.414-9.032l-5.46 4.72C8.613 39.421 15.717 46 24 46z" />
              <path d="M43.611 20.083L43.611 20.083H42V20H24v8h11.303c-0.792 2.237-2.231 4.166-4.087 5.571l5.126 5.126C39.991 35.341 44 28.163 44 20c0-1.341-0.138-2.65-0.389-3.917z" />
            </svg>
